...
const Footer = () => {
  return (
    <footer className="absolute inset-x-0 bottom-0 bg-[#202020] text-center text-[#ddd] lg:text-left">
      <div className="flex items-center justify-center">
        <div className="mx-6 flex py-5 text-center md:text-left  max-w-7xl">
          <div className="grid-1 grid gap-8 md:grid-cols-3 lg:grid-cols-3">
            ...
            <div className="">
              <h6 className="mb- flex justify-center font-semibold uppercase md:justify-start">Contact</h6>
              <p className="mb-4 flex items-center justify-center md:justify-start">
